...
def get_dataset(args):
    ...
    if args.dataset == 'cifar-10':
        ...
        train_dst   = CIFAR10(root='~/data/cifar10/', train=True, download=True,
                                        transform=transform_train,contrastive_learning=learning_type)
        val_dst     = CIFAR10(root='~/data/cifar10/', train=False, download=True,
    ...
    if args.dataset == 'cifar-100':
        ...
        train_dst   = CIFAR100(root='~/data/cifar100/', train=True, download=True,
                                        transform=transform_train,contrastive_learning=learning_type)
        val_dst     = CIFAR100(root='~/data/cifar100/', train=False, download=True,
                                       transform=transform_test,contrastive_learning=learning_type)
