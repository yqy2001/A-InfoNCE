...
def parser():
    ...
    parser.add_argument('--adv_weight', type=float, default=1, help="weight of adv loss: stop_grad stpg-weight")
    # must use with --stop_grad
    parser.add_argument('--stpg_degree', type=float, default=-1,
    ...
    parser.add_argument('--HN', action='store_true', default=False,
                    help='use HN')
    parser.add_argument('--tau', type=float, default=0.1, help='tau in HN')
...
def parser_load():
    ...
    parser.add_argument('--load_checkpoint', type=str, default='./checkpoint/ckpt.t7one_task_0', help='load checkpoint')
    ##### arguments for RoCL #####
    parser.add_argument('--lamda', default=256, type=float)
