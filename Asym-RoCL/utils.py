...
def checkpoint_train(model, acc, epoch, args, optimizer, save_name_add=''):
    # Save checkpoint.
    print('Saving..')
    state = {
        'epoch': epoch,
    ...
    save_name = './checkpoint/ckpt.t7' + args.name
...
def checkpoint(model, finetune_type, acc, acc_adv, epoch, args, optimizer, save_name_add=''):
    # Save checkpoint.
    print('Saving..')
    state = {
        'epoch': epoch,
    ...
    save_name = './checkpoint/ckpt.t7' + args.name + finetune_type
    save_name += save_name_add
